...
public class DeathFlowerModFeatures {
	...
	static {
		REGISTRY.put(DeathFlowerFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.VEGETAL_DECORATION,
				DeathFlowerFeature.GENERATE_BIOMES, DeathFlowerFeature.CONFIGURED_FEATURE));
	}
