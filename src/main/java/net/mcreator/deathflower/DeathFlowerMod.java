 ...
 *
 */
package net.mcreator.deathflower;
...
@Mod("death_flower")
public class DeathFlowerMod {
	public static final Logger LOGGER = LogManager.getLogger(DeathFlowerMod.class);
	public static final String MODID = "death_flower";
